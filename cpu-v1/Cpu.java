    ...
    static long[] runProgram(int[] mem) {
        ...
        while(true) {
            ...
            if(debug) {
                ...
                ", 34temp: %3d, 35base: %3d, 36pc: %3d, 37op: %3d, 38addr: %3d, 39acc: %3d\n", 
                pc, acc, opcode, address, mem[address], mem[34], mem[35], mem[36], mem[37], mem[38], mem[39]);
            }
            stats[opcode] += 1;
            switch(opcode) {
                case 0:  //halt
...
//                    break;
                case 8:  //loadprog
                    System.out.println("address: " + address + ", mem[address]: " + mem[address]);
...
//                    break;
    ...
    static void printStats(long[] stats) {
        String insts = "halt  load  store loadi storeiprint prtdbg      loadpgprtmemadd   sub   mul   div   mod   15    16    17    18    19    " +
                       ...
                       "eq    ne    lt    gt    le    ge    46    47    48    49    jmp   51    52    53    54    55    56    57    58    59    " +
        ...
        System.out.printf("%,16d Instructions Executed\n", total);
    }
    public static void main(String [] args) {
        ...
        System.out.println("base: " + base + ", acc: " + acc);
        long[] stats = runProgram(mem);
        printStats(stats);
        sc.close();
    }
}